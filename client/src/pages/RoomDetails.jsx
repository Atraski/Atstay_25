...
import { roomCommonData } from '../../../../../../Downloads/quickStay-assets/assets/assets'
const RoomDetails = () => {
    const {id} = useParams();
   ...
   return room && (
    <div className = 'py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-center gap-1 mt-1'>
        <StarRating />
        <p className='ml-2 mt-1'>300+ Reviews</p>
      </div>
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
              {room.amenities.map((item, index)=>(
                ...
                <div key = {index} className='flex items-center gap-2 px-3 py-2 rounde-lg bg-gray-100'>
  ...
  />
       ...
       <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability.
          ...
          to get the exact price for groups. The Guests will be allocated ground floor according to 
