...
const AllRooms = () => {
  ...
  // Helper: get first valid image url
  const getCover = (images) =>
    Array.isArray(images) ? images.find((u) => typeof u === 'string' && u.trim()) : undefined;
                ...
                <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
                  {Array.isArray(room.amenities) &&
                    room.amenities.map((item, index) => {
                      const iconSrc = facilityIcons?.[item];
                      return (
                        <div
                          key={index}
                        ...
                        >
                          {iconSrc ? (
                            <img src={iconSrc} alt={item} className="w-5 h-5" />
                          ) : null}
